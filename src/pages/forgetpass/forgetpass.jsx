        ...
        <div className="container">
            <div className="row m-5 no-gutters">
                ...
                <div className="col-md-6 bg-white p-5 logform" >
                    <h1 className="title" style={{ marginBottom: "5px" }}>  نسيت كلمة السر؟ </h1>
                    <h3 className="pb-3 " style={{ textAlign: "center", fontSize: "18px", color: "#96A0AD", marginBottom: "73px" }}> لتعيين كلمة سرجديدة ادخل بريدك الالكتروني  </h3>
