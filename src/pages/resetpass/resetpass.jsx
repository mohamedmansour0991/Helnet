        ...
        <div className="container">
            <div className="row m-5 no-gutters">
                ...
                <div className="col-md-6 bg-white p-5 logform" >
                    <h1 className="title" style={{ marginBottom: "5px" }}>  إعادة تعيين كلمة السر  </h1>
                    <h3 className="pb-3 " style={{ textAlign: "center", fontSize: "18px", color: "#96A0AD", marginBottom: "95px" }}> استخدم على الاقل 8 رموز تحتوي على ارقام وحروف</h3>
                    ...
                    <div className="form-style" style={{ textAlign: "end" }}>
                        ...
                        >
                            ...
                            <label htmlFor="password" className="input-label" style={{ marginBottom: "5px", fontWeight: "500" }}> كلمة سر جديدة</label>
                            ...
                            <label htmlFor="password" className="input-label" style={{ marginBottom: "5px", fontWeight: "500" }}>أعد كتابة كلمة السر</label>
                            ...
                            <div className="pb-2">
                                <button
                                    ...
                                    style={{
                                        ...
                                        fontSize: "24px", fontWeight: "600", letterSpacing: "1px", marginTop: "4.5rem", border: "none"
                                    }}>
                                    تسجيل الدخول
                                </button>
                            </div>
